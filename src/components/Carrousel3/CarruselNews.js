...
export default function Carrusel3(props) {
  ...
  const images = books.map((book) => book.image).slice(70, 100); //me devuelve un array de las primeras 10 imágenes
  const bookTitle = books.map((book) => book.title).slice(70, 100);
